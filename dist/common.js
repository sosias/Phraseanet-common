...
/***/ function(module, exports, __webpack_require__) {
	...
	var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol ? "symbol" : typeof obj; }; // @TODO enable lints
...
/***/ function(module, exports, __webpack_require__) {
	...
	function showOverlay(n, appendto, callback, zIndex) {
	    ...
	    if ((0, _jquery2.default)('#' + div).length === 0) {
	        if (typeof appendto === 'undefined') appendto = 'body';
	        (0, _jquery2.default)(appendto).append('<div id="' + div + '" style="display:none;">&nbsp;</div>');
	    }
	    ...
	    (0, _jquery2.default)('#' + div).css(css).addClass('overlay').fadeTo(500, 0.7).bind('click', function () {
	        callback();
	    });
	    if (navigator.userAgent.match(/msie/i) && navigator.userAgent.match(/6/)) {
	        (0, _jquery2.default)('select').css({
	            visibility: 'hidden'
	        });
	    }
	}
